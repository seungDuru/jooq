...
public class StaffDao extends DAOImpl<StaffRecord, Staff, Integer> {
    ...
    @Override
    public Integer getId(Staff object) {
     ...
     * upperInclusive</code>
     */
    public List<Staff> fetchRangeOfJStaffId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Staff> fetchByJStaffId(Integer... values) {
     ...
     */
    public Staff fetchOneByJStaffId(Integer value) {
     ...
     * Fetch a unique record that has <code>staff_id = value</code>
     */
    public Optional<Staff> fetchOptionalByJStaffId(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<Staff> fetchRangeOfJAddressId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Staff> fetchByJAddressId(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<Staff> fetchRangeOfJStoreId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Staff> fetchByJStoreId(Integer... values) {

...
public class CountryDao extends DAOImpl<CountryRecord, Country, Integer> {
     ...
     * upperInclusive</code>
     */
    public List<Country> fetchRangeOfJCountryId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Country> fetchByJCountryId(Integer... values) {
     ...
     */
    public Country fetchOneByJCountryId(Integer value) {
     ...
     * Fetch a unique record that has <code>country_id = value</code>
     */
    public Optional<Country> fetchOptionalByJCountryId(Integer value) {

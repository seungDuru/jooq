...
public class CustomerDao extends DAOImpl<CustomerRecord, Customer, Integer> {
    ...
    @Override
    public Integer getId(Customer object) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfJCustomerId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Customer> fetchByJCustomerId(Integer... values) {
     ...
     */
    public Customer fetchOneByJCustomerId(Integer value) {
     ...
     * Fetch a unique record that has <code>customer_id = value</code>
     */
    public Optional<Customer> fetchOptionalByJCustomerId(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfJStoreId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Customer> fetchByJStoreId(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfJAddressId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Customer> fetchByJAddressId(Integer... values) {

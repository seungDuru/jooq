...
public class LanguageDao extends DAOImpl<LanguageRecord, Language, Integer> {
    ...
    @Override
    public Integer getId(Language object) {
     ...
     * upperInclusive</code>
     */
    public List<Language> fetchRangeOfJLanguageId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Language> fetchByJLanguageId(Integer... values) {
     ...
     */
    public Language fetchOneByJLanguageId(Integer value) {
     ...
     * Fetch a unique record that has <code>language_id = value</code>
     */
    public Optional<Language> fetchOptionalByJLanguageId(Integer value) {

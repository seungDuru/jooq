...
public class StoreDao extends DAOImpl<StoreRecord, Store, Integer> {
    ...
    @Override
    public Integer getId(Store object) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfJStoreId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Store> fetchByJStoreId(Integer... values) {
     ...
     */
    public Store fetchOneByJStoreId(Integer value) {
     ...
     * Fetch a unique record that has <code>store_id = value</code>
     */
    public Optional<Store> fetchOptionalByJStoreId(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfJManagerStaffId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Store> fetchByJManagerStaffId(Integer... values) {
     ...
     */
    public Store fetchOneByJManagerStaffId(Integer value) {
     ...
     * Fetch a unique record that has <code>manager_staff_id = value</code>
     */
    public Optional<Store> fetchOptionalByJManagerStaffId(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfJAddressId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Store> fetchByJAddressId(Integer... values) {

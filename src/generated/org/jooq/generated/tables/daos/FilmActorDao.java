...
public class FilmActorDao extends DAOImpl<FilmActorRecord, FilmActor, Record2<Integer, Integer>> {
    ...
    @Override
    public Record2<Integer, Integer> getId(FilmActor object) {
     ...
     * upperInclusive</code>
     */
    public List<FilmActor> fetchRangeOfJActorId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<FilmActor> fetchByJActorId(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<FilmActor> fetchRangeOfJFilmId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<FilmActor> fetchByJFilmId(Integer... values) {

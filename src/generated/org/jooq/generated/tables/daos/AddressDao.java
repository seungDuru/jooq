...
public class AddressDao extends DAOImpl<AddressRecord, Address, Integer> {
    ...
    @Override
    public Integer getId(Address object) {
     ...
     * upperInclusive</code>
     */
    public List<Address> fetchRangeOfJAddressId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Address> fetchByJAddressId(Integer... values) {
     ...
     */
    public Address fetchOneByJAddressId(Integer value) {
     ...
     * Fetch a unique record that has <code>address_id = value</code>
     */
    public Optional<Address> fetchOptionalByJAddressId(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<Address> fetchRangeOfJCityId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Address> fetchByJCityId(Integer... values) {

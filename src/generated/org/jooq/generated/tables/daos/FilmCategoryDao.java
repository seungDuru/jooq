...
public class FilmCategoryDao extends DAOImpl<FilmCategoryRecord, FilmCategory, Record2<Integer, Integer>> {
    ...
    @Override
    public Record2<Integer, Integer> getId(FilmCategory object) {
     ...
     * upperInclusive</code>
     */
    public List<FilmCategory> fetchRangeOfJFilmId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<FilmCategory> fetchByJFilmId(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<FilmCategory> fetchRangeOfJCategoryId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<FilmCategory> fetchByJCategoryId(Integer... values) {

...
public class PaymentDao extends DAOImpl<PaymentRecord, Payment, Integer> {
    ...
    @Override
    public Integer getId(Payment object) {
     ...
     * upperInclusive</code>
     */
    public List<Payment> fetchRangeOfJPaymentId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Payment> fetchByJPaymentId(Integer... values) {
     ...
     */
    public Payment fetchOneByJPaymentId(Integer value) {
     ...
     * Fetch a unique record that has <code>payment_id = value</code>
     */
    public Optional<Payment> fetchOptionalByJPaymentId(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<Payment> fetchRangeOfJCustomerId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Payment> fetchByJCustomerId(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<Payment> fetchRangeOfJStaffId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Payment> fetchByJStaffId(Integer... values) {

...
public class CityDao extends DAOImpl<CityRecord, City, Integer> {
    ...
    @Override
    public Integer getId(City object) {
     ...
     * upperInclusive</code>
     */
    public List<City> fetchRangeOfJCityId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<City> fetchByJCityId(Integer... values) {
     ...
     */
    public City fetchOneByJCityId(Integer value) {
     ...
     * Fetch a unique record that has <code>city_id = value</code>
     */
    public Optional<City> fetchOptionalByJCityId(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<City> fetchRangeOfJCountryId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<City> fetchByJCountryId(Integer... values) {

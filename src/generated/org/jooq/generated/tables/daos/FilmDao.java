...
public class FilmDao extends DAOImpl<FilmRecord, Film, Integer> {
    ...
    @Override
    public Integer getId(Film object) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfJFilmId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Film> fetchByJFilmId(Integer... values) {
     ...
     */
    public Film fetchOneByJFilmId(Integer value) {
     ...
     * Fetch a unique record that has <code>film_id = value</code>
     */
    public Optional<Film> fetchOptionalByJFilmId(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfJLanguageId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Film> fetchByJLanguageId(Integer... values) {
     ...
     */
    public List<Film> fetchRangeOfJOriginalLanguageId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Film> fetchByJOriginalLanguageId(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfJRentalDuration(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<Film> fetchByJRentalDuration(Byte... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfJLength(Short lowerInclusive, Short upperInclusive) {
     ...
     */
    public List<Film> fetchByJLength(Short... values) {

...
public class CategoryDao extends DAOImpl<CategoryRecord, Category, Integer> {
    ...
    @Override
    public Integer getId(Category object) {
     ...
     * upperInclusive</code>
     */
    public List<Category> fetchRangeOfJCategoryId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Category> fetchByJCategoryId(Integer... values) {
     ...
     */
    public Category fetchOneByJCategoryId(Integer value) {
     ...
     * Fetch a unique record that has <code>category_id = value</code>
     */
    public Optional<Category> fetchOptionalByJCategoryId(Integer value) {

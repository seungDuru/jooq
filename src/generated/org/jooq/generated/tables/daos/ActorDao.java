...
public class ActorDao extends DAOImpl<ActorRecord, Actor, Integer> {
    ...
    @Override
    public Integer getId(Actor object) {
     ...
     * upperInclusive</code>
     */
    public List<Actor> fetchRangeOfJActorId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<Actor> fetchByJActorId(Integer... values) {
     ...
     */
    public Actor fetchOneByJActorId(Integer value) {
     ...
     * Fetch a unique record that has <code>actor_id = value</code>
     */
    public Optional<Actor> fetchOptionalByJActorId(Integer value) {
